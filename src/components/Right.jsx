    ...
    <div className="right-wrapper">
      <section style={{ position: 'relative' }}>
        ...
        <div className="social-wrapper">
          <h4 className="connect">Conect with Me on my Socials</h4>
      ...
      <section className='down-image-box'>
      ...
      <section className="contact-box">
        ...
        <div className="con-middle">
          <div className="resume-box">
            <a href="tel:=233548356263" className="number">
              <IoMdCall className='call-btn' />
              +233 548 356 263
            </a>
            <div>
              <a href='mailto:samankwaa.frempong@gmail.com' className="address">samankwaa.frempong@gmail.com</a>
            </div>
            <button type="button" onClick={() => window.open("https://drive.google.com/file/d/1qvSEffCBY5eYUBen1Dc2YQUSMdMP6IIe/view?usp=sharing", "_blank")}>Get Resume</button>
          </div>
        </div>
